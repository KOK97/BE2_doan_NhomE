...
.btnCapNhat:hover, .btnXoa:hover, .btnthietlap:hover {
    background-color: #f44336;
}
...
@section('main-content')
                                            ...
                                            <div>
                                                <div class="y3hZ9E">
                                                    <div style="display: flex;">
                                                        <button data-modal="modal" data-modal-id="#quick-look" class="btn btn--e-brand-b-2" type="submit">Thêm
                                                            mới</button>
                                                    </div>
                                                </div>
                                            </div>
                                                              ...
                                                              <div class="kTXLeO">
                                                                <div class="R1TwAI">
                                                                  <div class="OanBpz Jl3DqQ">
                                                                    <div class="t0HxU5">
                                                                      ...
                                                                      <input class="AukTuV" type="text" name="hovaten" placeholder="Họ và tên" autocomplete="name"
                                                                        maxlength="64" value="" required>
                                                                    </div>
                                                                  </div>
                                                                  <div class="FqyAgi">
                                                                  ...
                                                                  <div class="OanBpz H7kyc3">
                                                                    <div class="t0HxU5">
                                                                      ...
                                                                      <input class="AukTuV" type="text" name="sdt" placeholder="Số điện thoại" value="" maxlength="10" required>
                                                                    </div>
                                                                  </div>
                                                                </div>
                                                                <div class="R1TwAI">
                                                                  <div class="tinh" style="margin-bottom: 10px;margin-top: 10px;">
                                                                  ...
                                                                  <div class="quan" style="margin-bottom: 10px;margin-top: 10px;">
                                                                    <label for="district">Quận/Huyện:</label>
                                                                    <select id="district" name="district" required>
                                                                      <option value="" disabled selected>Chọn Quận/Huyện</option><br>
                                                                    </select><br>
                                                                  </div>
                                                                  <div class="xa" style="margin-bottom: 10px;margin-top: 10px;">
                                                                ...
                                                                <div class="OanBpz H7kyc3">
                                                                  <div class="t0HxU5">
                                                                    ...
                                                                    <input class="AukTuV" type="text" name="diachicuthe" placeholder="Địa chỉ cụ thể" value="" required>
                                                                  </div>
                                                                </div>
                                                                <div class="NlC19f">
                                                                  <div>
                                                                    <div class="stardust-popover B6On17" id="stardust-popover4" tabindex="0">
                                                                      <div role="button" class="stardust-popover__target"><label class="_uXoWc UWv91s"><input class="sp7inB"
                                                                            type="checkbox" name="checkbox" role="checkbox" aria-checked="true" aria-disabled="true">
                                                                          <div class="H4iGzY ltxYiB mDZXh8"></div>Đặt làm địa chỉ mặc định
                                                                        </label></div>
                                                                    </div>
                                                                  </div>
                                                                </div>
                                                              </div>
                                                              <div class="Lr7eTF" style="justify-content: end;display: flex;">
                                                  ...
                                                  <tbody>
                                                    @foreach ($diachi as $item)
                                                      @if ($item->diachimacdinh == 1)
                                                          ...
                                                          <td>
                                                            <a class="address-book-edit btn--e-transparent-platinum-b-2" href="{{route('diachi.delete',$item->id)}}">Xóa</a>
                                                            @if ($item->diachimacdinh == 1)
                                                            <a class="address-book-edit btn--e-transparent-platinum-b-2" href="{{route('diaChiMacDinh.update',$item->id)}}" style="display: none">Dùng</a>
                                                            @else
                                                            <a class="address-book-edit btn--e-transparent-platinum-b-2" href="{{route('diaChiMacDinh.update',$item->id)}}">Dùng</a>
                                                            @endif
    ...
    <script>
        ...
        const districts = {
          "Hà Nội": ["Ba Đình", "Hoàn Kiếm", "Hai Bà Trưng", "Đống Đa", "Cầu Giấy", "Hoàng Mai", "Thanh Xuân", "Long Biên", "Bắc Từ Liêm", "Nam Từ Liêm", "Hà Đông"],
          "TP. Hồ Chí Minh": ["Quận 1", "Quận 2", "Quận 3", "Quận 4", "Quận 5", "Quận 6", "Quận 7", "Quận 8", "Quận 9", "Quận 10", "Quận 11", "Quận 12", "Bình Thạnh", "Thủ Đức", "Gò Vấp", "Phú Nhuận", "Tân Bình", "Tân Phú", "Bình Tân", "Củ Chi", "Hóc Môn", "Bình Chánh", "Nhà Bè", "Cần Giờ"]
        };
        const locations = {
          "Hà Nội": {
            "Ba Đình": ["Cống Vị", "Điện Biên", "Đội Cấn", "Ngọc Hà", "Ngọc Khánh", "Kim Mã", "Liễu Giai", "Nguyễn Trung Trực"],
            "Hoàn Kiếm": ["Phúc Tân", "Đồng Xuân", "Cửa Đông", "Cửa Nam", "Hàng Bồ", "Hàng Gai", "Chương Dương", "Hàng Trống"],
            // Thêm các xã/phường cho các quận/huyện khác của Hà Nội
          },
          "TP. Hồ Chí Minh": {
            "Quận 1": ["Bến Nghé", "Bến Thành", "Cầu Kho", "Cầu Ông Lãnh", "Cô Giang", "Đa Kao", "Nguyễn Cư Trinh", "Nguyễn Thái Bình"],
            "Quận 2": ["An Phú", "Bình An", "Bình Khánh", "Bình Trưng Đông", "Bình Trưng Tây", "Cát Lái", "Thạnh Mỹ Lợi", "Thảo Điền"],
            "Quận 3": ["Bến Thành", "Cầu Ông Lãnh", "Cô Giang", "Đa Kao", "Nguyễn Cư Trinh", "Nguyễn Đình Chiểu", "Nguyễn Thái Bình", "Nguyễn Văn Trỗi"],
            "Quận 4": ["Bến Nghé", "Thạnh Mỹ Lợi", "Thạnh Qưới", "Thạnh Xuân", "Vĩnh Hội Đông", "Vĩnh Hội Tây", "Vĩnh Khánh"],
            "Quận 5": ["19 Tháng 5", "An Bình", "Bình Hưng Hòa", "Bình Thành", "Bình Trị Đông", "Bình Trị Đông A", "Bùi Hữu Nghĩa", "Cây Gõ"]
          }
        };
