                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30 filter__item headphone">
                                    <div class="product-o product-o--hover-on product-o--radius">
                                                ...
                                                <form method="POST" action="{{ route('product.wishlist.add') }}">
                                                    <ul class="product-o__action-list">
                                                        ...
                                                        <li>
                                                            ...
                                                            <a data-tooltip="tooltip" data-placement="top" title="Add to Wishlist"><button href="{{ route('product.wishlist.add') }}" type="submit"><i class="fas fa-heart"></i></button></a>
                                                        </li>
                                                    </ul>
                                                </form>
                                            </div>
                                        ...
                                        <span class="product-o__category">
                                            <a href="shop-side-version-2.html">{{ $product->author }}</a></span>
