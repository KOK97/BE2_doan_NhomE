                            ...
                            <div class="col-lg-9 col-md-12">
                                    ...
                                    <div class="dash__pad-2">
                                        ...
                                        <form class="m-order u-s-m-b-30" method="GET"
                                            ...
                                            <div class="m-order__select-wrapper" style="margin:15px">
                                                ...
                                                <label class="u-s-m-r-8" for="my-order-sort">Trạng thái đơn hàng:</label><select
                                                    class="select-box select-box--primary-style" id="my-order-sort"
                                                    name="optionTrangThai" selected="dahuy">
                                            ...
                                            <button type="submit" class="btn btn-white mt-3 mb-3" style="background-color: gainsboro;">Tìm</button>
                                            </div>
                                        </form>
                                                        ...
                                                        <div class="dash-l-r">
                                                            ...
                                                            <div>
                                                                <div class="dash__link dash__link--brand">
                                                                    ...
                                                                    <a href="dash-manage-order.html" style="color:green;margin-right: 20px;"><?php echo $order->trangthai ?></a>
                                                                    <a href="{{route('order.huyDonHang',$order->id)}}">Hủy đơn hàng</a>
                                                                    @else
                                                                    <a href="dash-manage-order.html" style="color:green;margin-right: 20px;"><?php echo $order->trangthai ?></a>
                                                                    @endif
                                                                </div>
                                ...
                                <div style="display: flex;flex-direction: row-reverse;">
                                    <span class="manage-o__text-2 u-c-silver">Tổng đơn hàng:
                                        <span class="manage-o__text-2 u-c-secondary">$<?php echo $order->tongtien; ?></span></span></div>
                                </div>
