                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="pd-rev">
                                <div class="pd-tab__rev">
                                    ...
                                    <div class="u-s-m-b-30">
                                        <form class="pd-tab__rev-f1" >
                                            <div class="rev-f1__group">
                                                <div class="u-s-m-b-15">
                                                    <h2>({{$reviews->count()}}) đánh giá cho sản phẩm {{$product->name}}</h2>
                                                </div>
                                                <div class="u-s-m-b-15">
                                            ...
                                            <div class="rev-f1__review">
                                                ...
                                                {{-- <div class="review-o u-s-m-b-15">
                                                    ...
                                                    <p class="review-o__text">Lorem Ipsum is simply dummy text
                                    ...
                                    <div class="u-s-m-b-30">
                                        <form class="pd-tab__rev-f2"  action="{{ route('product.comment',$product->id) }}" method="POST">
                                            ...
                                            <div class="rev-f2__group">
                                                <div class="u-s-m-b-15">
                                                    ...
                                                    <label class="gl-label" for="reviewer-text">YOUR REVIEW
                                                        *</label>
                                                    <textarea class="text-area text-area--primary-style" name="review_content" id="review_content" placeholder="Input Review Content"></textarea>
